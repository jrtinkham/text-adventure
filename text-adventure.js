...
$(document).ready(function () {
    ...
    var rooms = ["Dungeon Entrance", "Corridor of uncertainty", 'Ancient old cavern', "Great Cavern", "Underground River", "Stream", 'Dungeon Stream', "Dungeon Pool",
    ...
    */
    ...
    function DisplayGameScreen() {
        ...
        if (inventory.length > 0) {
            DisplayInventory("You are carrying: ");
            for (var i = 0; i < inventory.length ; i++) {
                DisplayInventory("- " + GameObjects[inventory[i]]);
            }
        }
    ...
    function DisplayInventory(text){
